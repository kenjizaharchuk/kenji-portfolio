      ...
      >
        <div className="flex flex-col md:flex-row items-center gap-7 md:gap-10">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-foreground/80 text-base md:text-lg leading-relaxed font-alike font-semibold">
            ...
            <p className="text-foreground/80 text-base md:text-lg leading-relaxed mt-4 font-alike font-semibold">
