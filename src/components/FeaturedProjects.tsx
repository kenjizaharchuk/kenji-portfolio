...
export function FeaturedProjects() {
  ...
  return (
    ...
    >
      <div className="w-[74vw] max-w-3xl mx-auto">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10 h-full p-3.5 md:p-4 flex flex-col justify-end">
                    <p
                      data-card-part="subtitle"
                      className="font-display text-white/70 text-[10px] md:text-[11px] font-semibold tracking-wider uppercase mb-1"
                    >
                      {category}
                    </p>
                    <h3
